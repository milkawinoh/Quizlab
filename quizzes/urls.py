...
from .views import QuizDeleteView, QuizUpdateView, login_view, register, quiz_list, take_quiz, quiz_result, create_quiz, add_question, quiz_detail, QuestionUpdateView, QuestionDeleteView, my_quizzes
...
urlpatterns = [
    ...
    path('my_results/', views.user_quiz_results, name='user_quiz_results'),
]
