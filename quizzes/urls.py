...
from .views import QuizDeleteView, login_view, register, quiz_list, take_quiz, quiz_result, create_quiz, add_question, quiz_detail, QuestionUpdateView, QuestionDeleteView, my_quizzes
